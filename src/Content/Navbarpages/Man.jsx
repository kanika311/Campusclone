    ...
    <div key={index} className="flex flex-col">
      ...
      <div className="flex flex-col items-start mt-4">
        <img
          ...
          src="https://img.freepik.com/free-photo/male-foot-with-brown-leather-shoes-jeans_1150-5998.jpg?ga=GA1.1.416566523.1736844263&semt=ais_hybrid"
          alt="Men's Shoes"
        />
        <div className="text-sm font-medium">Men's Shoes</div>
      </div>
    </div>
  );
}
